...
$myNumberIsMultipleOf3 = isMultipleOf(3, $myNumber);
$myNumberIsMultipleOf5 = isMultipleOf(5, $myNumber);
$myNumberIsMultipleOf8 = isMultipleOf(8, $myNumber);
$myNumberIsMultipleOf15 = isMultipleOf(15, $myNumber);
